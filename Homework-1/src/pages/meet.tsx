...
function MeetingPage() {
    ...
    const fanTokenAddress = '0xF9C0F80a6c67b1B39bdDF00ecD57f2533ef5b688';
    const fanTokenBalance = tokenBalances.find(token => token.token_address === fanTokenAddress);
    const fanTokenBalanceFormatted = fanTokenBalance ? formatBalance(fanTokenBalance.balance) : 0; 
    ...
    const isEligible = Number(native) > 0 || Number(fanTokenBalanceFormatted) > 1;
